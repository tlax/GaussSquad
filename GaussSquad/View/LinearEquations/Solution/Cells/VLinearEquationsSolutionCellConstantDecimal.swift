...
class VLinearEquationsSolutionCellConstantDecimal:VLinearEquationsSolutionCell
{
        ...
        index:IndexPath)
    {
        guard
            ...
            let model:MLinearEquationsSolutionEquationItemConstantDecimal = model as? MLinearEquationsSolutionEquationItemConstantDecimal
