...
class MLinearEquationsSolutionStrategyConstantsRight:MLinearEquationsSolutionStrategy
{
    class func constantsLeft(step:MLinearEquationsSolutionStep) -> MLinearEquationsSolutionStrategyConstantsRight?
    {
        ...
        indexConstant:Int)
    {
        ...
        self.indexConstnat = indexConstnat
